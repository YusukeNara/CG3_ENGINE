...
Model* Model::CreateFromOBJ(const std::string& modelname, bool isSmoothing)
{
	// メモリ確保
	Model* instance = new Model;
	instance->Initialize(modelname,isSmoothing);
...
void Model::Initialize(const std::string& modelname, bool isSmoothing)
{
